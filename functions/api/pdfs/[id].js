export async function onRequestGet({ env, params }) {
  ...
  const filename = value.metadata?.filename || (id.startsWith("catalogoinsumosmistiko") ? "CatalogoInsumosMistiko.pdf" : id.startsWith("catalogomistiko") ? "catalogomistiko.pdf" : "precios-mistiko.pdf");
